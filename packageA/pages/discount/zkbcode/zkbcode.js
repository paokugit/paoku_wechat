...
Page({
    ...
    setbtn:function(){
        wx.navigateTo({
            url: '/packageA/pages/discount/zkbdiscount/zkbdiscount',
        })
    },
    recordbtn:function(){
        wx.navigateTo({
            url: '/packageA/pages/discount/recordlist/recordlist?cate='+catenum,
        })
    },
accountbtn:function(){
    wx.navigateTo({
        url: '/packageA/pages/discount/merchaccount/merchaccount?merchantid='+merchid ,
    })
},
