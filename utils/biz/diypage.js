    ...
    get: function(e, i, o) {
        ...
        a.get("diypage", {
            ...
            var p = {
                ...
                usediypage: !0,
                startadv: i.startadv,
                // list: i.diypage.items.M1560245438761.data
            };
            // list || (list = []), list.length > 0 && (p.page = e.data.page + 1, p.list = i.diypage.items.M1560245438761.data.concat(list),
            //     list.length <pagesize && (p.loaded = !0)), e.setData(p);
                ...
                if (void 0 != i.diypage.items) {
                    ...
                    if (t.each(i.diypage.items, function(t, o) {
                            if (s.push(o.id), "topmenu" == o.id) {
                                if (2 == o.style.showtype) {
                                    r = 78 * Math.ceil(o.data.length / 4);
                                    e.setData({
                                        topmenuheight: r
                                    });
                                } else {
