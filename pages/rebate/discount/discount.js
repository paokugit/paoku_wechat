...
Page({
    ...
    withdrawbtn: function() {
        ...
        if (conbind == 0) {
            ...
            wx.navigateTo({
                url: '/packageA/pages/contribute/withdraw/withdraw',
            })
        }
    },
    transferbtn: function() {
        wx.navigateTo({
            url: '/packageA/pages/discount/transfer/transfer',
        })
    },
    ...
    codebtn: function() {
        if (merchid == undefined) {
            ...
            if (agentlevel == 0 || agentlevel == 1) {
                ...
                wx.navigateTo({
                    url: '/packageA/pages/discount/merchcode/merchcode',
                })
                ...
                wx.showModal({
                    ...
                    success: function(res) {
                        if (res.cancel) {
                            ...
                            // 确定
                            wx.navigateTo({
                                url: '/packageA/pages/contribute/record/record',
                            })
                        }
                    }
                })
