 ...
 Page((a = {
   data: (e = {
       ...
       mobile: "display: none;",
       insidetit: '',
       ticketA:"yhj_img_bg_red@2x",
       ticketB: "yhj_img_bg_hs@2x",
       ticketC: "yhj_img_bg_ls@2x",
       commodityid:'',
       isFold: true
  ...
  getDetail: function(t) {
    ...
    wx.request({
      url: 'http://192.168.3.104:8081/app/ewei_shopv2_api.php?i=1&r=app.shop.shop_goods_detail',
      data: {
        id: t.id,
        // id: 3003,
        token: openid,
      ...
      success(res) {
        ...
        if(res.data.error == 0){
          ...
          l.wxParse("wxParseData", "html", objData.content, e, "0");
          e.setData({
            goods: objData,
            navbar: objData.navbar,
          });
   ...
   onShareAppMessage: function(res) {
     console.log(this.data.options.id, sharemid);
     var that = this;
     that.setData({
       closeBtn: !1
     })
